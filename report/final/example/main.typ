#import "@preview/bloated-neurips:0.5.0": botrule, midrule, paragraph, toprule, url, neurips2024
#import "/example/logo.typ": LaTeX, LaTeXe, TeX
...
#let authors = (
  (name: "Mondo Jiang",
   ...
   equal: true),
  (name: "Daniel Smedema", affl: "uw", equal: true),
)
